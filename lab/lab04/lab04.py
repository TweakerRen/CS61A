def divide(quotients, divisors):
    ...
    """
    return {quotient: [divisor for divisor in divisors 
                       if divisor / quotient == divisor // quotient] 
...
def closer_city(lat, lon, city_a, city_b):
    ...
    'Bucharest'
    """
    objective = make_city ('object', lat, lon)
    return get_name(city_a) if distance(objective, city_a) < distance(objective, city_b) else get_name(city_b)
